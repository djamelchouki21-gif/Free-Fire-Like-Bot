...
# === CONFIG ===
BOT_TOKEN = os.getenv("7104304047:AAEJiPVYwZGwAmSUmeYmjrzSMqvViRX2XGc")

if not BOT_TOKEN:
    logger.error("❌ BOT_TOKEN not found! Please set your bot token in environment variables.")
    sys.exit(1)

REQUIRED_CHANNELS = ["@botinfofreefire"]
GROUP_JOIN_LINK = "https://t.me/botinfofreefire"
OWNER_ID = 5176961308
OWNER_USERNAME = "@flash_king_DZ"
